...
abstract class AppLocalizations {
  ...
  /// No description provided for @mcpServerType.
  ///
  /// In en, this message translates to:
  /// **'Connection Type'**
  String get mcpServerType;

  /// No description provided for @mcpServerTypeDesc.
  ///
  /// In en, this message translates to:
  /// **'Select MCP Server connection type'**
  String get mcpServerTypeDesc;
  ...
  /// No description provided for @mcpServerUrlPlaceholder.
  ///
  /// In en, this message translates to:
  /// **'Enter server address or command'**
  String get mcpServerUrlPlaceholder;

  /// No description provided for @mcpServerUrlDesc.
  ///
  /// In en, this message translates to:
  /// **'URL for HTTP/WebSocket or command for stdio'**
  String get mcpServerUrlDesc;

  /// No description provided for @mcpServerHelpTitle.
  ///
  /// In en, this message translates to:
  /// **'About MCP Server'**
  String get mcpServerHelpTitle;

  /// No description provided for @mcpServerHelpContent.
  ///
  /// In en, this message translates to:
  /// **'MCP (Model Context Protocol) Server allows connecting to external tools and services.\n\nConnection Types:\n• HTTP: Connect via HTTP/HTTPS URL\n• stdio: Connect via standard input/output (local command)\n• WebSocket: Connect via WebSocket URL\n\nEnter the appropriate address based on your connection type.'**
  String get mcpServerHelpContent;

  /// No description provided for @mcpServerNamePlaceholder.
  ///
  /// In en, this message translates to:
  /// **'MCP Server Name'**
  String get mcpServerNamePlaceholder;

  /// No description provided for @mcpServerEnable.
  ///
  /// In en, this message translates to:
  /// **'Enable Server'**
  String get mcpServerEnable;

  /// No description provided for @mcpServerAddressHttpDesc.
  ///
  /// In en, this message translates to:
  /// **'HTTP/HTTPS URL address'**
  String get mcpServerAddressHttpDesc;

  /// No description provided for @mcpServerAddressWebsocketDesc.
  ///
  /// In en, this message translates to:
  /// **'WebSocket URL address'**
  String get mcpServerAddressWebsocketDesc;

  /// No description provided for @mcpServerAddressStdioDesc.
  ///
  /// In en, this message translates to:
  /// **'Local command line command'**
  String get mcpServerAddressStdioDesc;

  /// No description provided for @mcpServerAddressGenericDesc.
  ///
  /// In en, this message translates to:
  /// **'Server address'**
  String get mcpServerAddressGenericDesc;

  /// No description provided for @mcpServerDeleteConfirm.
  ///
  /// In en, this message translates to:
  /// **'Are you sure you want to delete MCP Server \"{name}\"?'**
  String mcpServerDeleteConfirm(String name);

  /// No description provided for @mcpServerNoConfig.
  ///
  /// In en, this message translates to:
  /// **'No MCP Server configured'**
  String get mcpServerNoConfig;

  /// No description provided for @mcpServerAddHint.
  ///
  /// In en, this message translates to:
  /// **'Tap the + button in the top right to add the first MCP Server'**
  String get mcpServerAddHint;

  /// No description provided for @mcpServerDisabled.
  ///
  /// In en, this message translates to:
  /// **'Disabled'**
  String get mcpServerDisabled;

  /// No description provided for @mcpServerErrorNameRequired.
  ///
  /// In en, this message translates to:
  /// **'Please enter server name'**
  String get mcpServerErrorNameRequired;

  /// No description provided for @mcpServerErrorAddressRequired.
  ///
  /// In en, this message translates to:
