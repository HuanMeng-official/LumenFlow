...
class AppLocalizationsJa extends AppLocalizations {
  ...
  @override
  String get restartAppToApplyLanguage => '言語の変更を適用するにはアプリを再起動してください';
  ...
  @override
  String get toolsSettings => 'ツール';

  @override
  String get mcpServerSettings => 'MCPサーバー';

  @override
  String get mcpServerType => '接続タイプ';

  @override
  String get mcpServerTypeDesc => 'MCPサーバーの接続タイプを選択';

  @override
  String get mcpServerUrl => 'サーバーアドレス';

  @override
  String get mcpServerUrlPlaceholder => 'サーバーアドレスまたはコマンドを入力';

  @override
  String get mcpServerUrlDesc => 'HTTP/WebSocketはURL、stdioはコマンドを使用';

  @override
  String get mcpServerHelpTitle => 'MCPサーバーについて';

  @override
  String get mcpServerHelpContent => 'MCP（モデルコンテキストプロトコル）サーバーは、外部ツールやサービスに接続できます。\n\n接続タイプ：\n• HTTP：HTTP/HTTPS URLで接続\n• stdio：標準入出力で接続（ローカルコマンド）\n• WebSocket：WebSocket URLで接続\n\n接続タイプに応じて適切なアドレスを入力してください。';

  @override
  String get mcpServerNamePlaceholder => 'MCPサーバー名';

  @override
  String get mcpServerEnable => 'サーバーを有効にする';

  @override
  String get mcpServerAddressHttpDesc => 'HTTP/HTTPS URLアドレス';

  @override
  String get mcpServerAddressWebsocketDesc => 'WebSocket URLアドレス';

  @override
  String get mcpServerAddressStdioDesc => 'ローカルコマンドラインコマンド';

  @override
  String get mcpServerAddressGenericDesc => 'サーバーアドレス';

  @override
  String mcpServerDeleteConfirm(String name) {
    return 'MCPサーバー「$name」を削除してもよろしいですか？';
  }

  @override
  String get mcpServerNoConfig => 'MCPサーバーが構成されていません';

  @override
  String get mcpServerAddHint => '右上の+ボタンをタップして、最初のMCPサーバーを追加してください';

  @override
  String get mcpServerDisabled => '無効';

  @override
  String get mcpServerErrorNameRequired => 'サーバー名を入力してください';

  @override
  String get mcpServerErrorAddressRequired => 'サーバーアドレスを入力してください';
}
