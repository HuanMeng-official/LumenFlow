...
class AppLocalizationsEn extends AppLocalizations {
  ...
  @override
  String get toolsSettings => 'Tools';

  @override
  String get mcpServerSettings => 'MCP Server';

  @override
  String get mcpServerType => 'Connection Type';

  @override
  String get mcpServerTypeDesc => 'Select MCP Server connection type';

  @override
  String get mcpServerUrl => 'Server Address';

  @override
  String get mcpServerUrlPlaceholder => 'Enter server address or command';

  @override
  String get mcpServerUrlDesc => 'URL for HTTP/WebSocket or command for stdio';

  @override
  String get mcpServerHelpTitle => 'About MCP Server';

  @override
  String get mcpServerHelpContent => 'MCP (Model Context Protocol) Server allows connecting to external tools and services.\n\nConnection Types:\n• HTTP: Connect via HTTP/HTTPS URL\n• stdio: Connect via standard input/output (local command)\n• WebSocket: Connect via WebSocket URL\n\nEnter the appropriate address based on your connection type.';

  @override
  String get mcpServerNamePlaceholder => 'MCP Server Name';

  @override
  String get mcpServerEnable => 'Enable Server';

  @override
  String get mcpServerAddressHttpDesc => 'HTTP/HTTPS URL address';

  @override
  String get mcpServerAddressWebsocketDesc => 'WebSocket URL address';

  @override
  String get mcpServerAddressStdioDesc => 'Local command line command';

  @override
  String get mcpServerAddressGenericDesc => 'Server address';

  @override
  String mcpServerDeleteConfirm(String name) {
    return 'Are you sure you want to delete MCP Server \"$name\"?';
  }

  @override
  String get mcpServerNoConfig => 'No MCP Server configured';

  @override
  String get mcpServerAddHint => 'Tap the + button in the top right to add the first MCP Server';

  @override
  String get mcpServerDisabled => 'Disabled';

  @override
  String get mcpServerErrorNameRequired => 'Please enter server name';
