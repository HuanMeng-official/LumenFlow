...
class _CodeBlockWithCopyButton extends StatefulWidget {
  ...
  State<_CodeBlockWithCopyButton> createState() =>
      __CodeBlockWithCopyButtonState();
}
...
class MessageBubble extends StatefulWidget {
  ...
  final Function(Message message)? onEdit;
  final Function(Message message)? onRegenerate;
  final Function(Message message)? onResubmit;
  ...
  void _showMessageMenu() {
    ...
    showCupertinoModalPopup(
      ...
      builder: (context) => CupertinoActionSheet(
        ...
        message: widget.message.isUser ? Text(l10n.editMessageHint) : null,
        actions: [
          ...
          if (widget.message.isUser && widget.onResubmit != null)
            CupertinoActionSheetAction(
              onPressed: () {
                Navigator.of(context).pop();
                widget.onResubmit!(widget.message);
              },
              child: Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
          ...
          if (!widget.message.isUser && widget.onRegenerate != null)
            CupertinoActionSheetAction(
              onPressed: () {
                Navigator.of(context).pop();
        ...
        child: Row(
          ...
          children: [
                                  ...
                                  child: MarkdownBody(
                                    ...
                                    styleSheet: MarkdownStyleSheet(
                                      ...
                                      code: TextStyle(
                                        fontSize: 12,
                                        fontFamily:
                                            'JetBrains Mono, SF Mono, Courier, monospace',
                                        color: brightness == Brightness.dark
                                            ? CupertinoColors
                                                  .systemGreen
                                                  .darkColor
            ...
            if (widget.message.isUser) ...[
              const SizedBox(width: 8),
              _userProfile != null
                  ? AvatarWidget(userProfile: _userProfile!, size: 32)
                  : Container(
                      width: 32,
                      height: 32,
                      decoration: BoxDecoration(
